...
e acrescenta dois achados in\'editos ao diagn\'ostico, indispon\'iveis
na edi\c{c}\~ao anterior: o uso emergente de assistentes de
intelig\^encia artificial como canal de informa\c{c}\~ao sobre
investimentos (ver Se\c{c}\~ao~\ref{sec:contextualizacao}) e a
confirma\c{c}\~ao de que 12\% da popula\c{c}\~ao brasileira consegue
poupar mas mant\'em o dinheiro parado sem aplicar em nenhum produto
financeiro (Perfil Economiza e N\~ao Investe), evidenciando o funil
