...
backtesting e valida\c{c}\~ao com especialistas e gerentes).
...
\begin{itemize}
  \item[] \textit{5.2. Arquitetura do agente e m\'odulos Python -- valida\c{c}\~ao t\'ecnica (objetivos b e c) [PENDENTE]}
  ...
  \item[] \textit{5.5. Avalia\c{c}\~ao t\'ecnica dos especialistas e resultado do question\'ario SUS (objetivo e) [PENDENTE]}
\end{itemize}
