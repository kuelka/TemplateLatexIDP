...
\begin{itemize}
  ...
  \item[] \textit{5.3. Base de conhecimento regulat\'oria RAG -- recall@k e prioriza\c{c}\~ao de norma vigente (objetivo d) [PENDENTE -- corpus normativo fechado (6 de 6 normas verificadas, 5 de 6 PDFs arquivados) em bibliografia/normas-rag-corpus.md]}
