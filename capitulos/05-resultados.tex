...
\begin{itemize}
  ...
  \item[] \textit{5.5. Avalia\c{c}\~ao t\'ecnica automatizada (objetivo e) [PENDENTE -- literatura do benchmark de suitability j\'a levantada em bibliografia/literatura-suitability-benchmark.md]}
\end{itemize}
