...
aferida por compara\c{c}\~ao autom\'atica contra faixas de aloca\c{c}\~ao
esperadas por perfil de risco, derivadas de literatura acad\^emica --
mesmo desenho de \textcite{oehler2024}, detalhado a seguir --, e n\~ao
por julgamento subjetivo de especialista. A dimens\~ao (iii), clareza da
...
% construido, puxar para ca a literatura ja levantada e verificada em
% bibliografia/literatura-suitability-benchmark.md -- Jacobs, Muller e Weber
% (2014, lido na integra: NAO da 3 faixas por perfil, e sim uma alocacao de
% consenso "one-size-fits-all"; as 3 faixas de Oehler & Horn sao sintese
% deles combinando os 3 artigos, nao extracao direta do Jacobs et al.),
% Foerster et al. (2017) e Choi (2022, ambos ainda no nivel de confirmacao
% bibliografica, acesso aberto disponivel).
...
Challenge. A dimens\~ao de suitability \'e avaliada por benchmark de
faixas esperadas por perfil de risco derivado de literatura acad\^emica,
seguindo o modelo de \textcite{oehler2024}, que compara recomenda\c{c}\~oes
de IA generativa contra um padr\~ao de refer\^encia derivado da
literatura. Reportar os resultados nesses
