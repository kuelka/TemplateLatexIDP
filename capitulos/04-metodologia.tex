...
derivada aplicando, sobre essa renda de refer\^encia, o percentual de
\textit{aumento do ativo} -- despesas com aquisi\c{c}\~ao de bens e
outros investimentos, por classe de rendimento -- medido pela Pesquisa
de Or\c{c}amentos Familiares 2017-2018 \autocite{ibge2019pof}. A
escolha desse indicador, em vez do conceito alternativo de
\textit{varia\c{c}\~ao patrimonial} da mesma pesquisa, resultou de um
processo expl\'icito de verifica\c{c}\~ao: a defini\c{c}\~ao de
varia\c{c}\~ao patrimonial inclui saques de poupan\c{c}a como exemplo
prim\'ario, e seu posicionamento cont\'abil do lado da renda recebida
sugere que o indicador capta, ao menos parcialmente, desacumula\c{c}\~ao
de reservas -- o oposto do comportamento de investimento que a
calibra\c{c}\~ao pretende representar. Aumento do ativo, por ser uma
r\'ubrica de despesa vinculada \`a aquisi\c{c}\~ao de bens, n\~ao
apresenta essa ambiguidade de dire\c{c}\~ao.
