...
LLM-as-a-judge, conforme detalhado a seguir. Essa rubrica complementa --
sem substituir -- o question\'ario SUS previsto em H2, permitindo
...
respons\'aveis pelos pilares (i) e (ii) ser\~ao profissionais de mercado
n\~ao vinculados ao BRB, distintos dos gerentes de front-office que
participam da etapa de valida\c{c}\~ao de usabilidade, evitando a
sobreposi\c{c}\~ao entre avalia\c{c}\~ao t\'ecnica independente e
aceita\c{c}\~ao organizacional interna.
