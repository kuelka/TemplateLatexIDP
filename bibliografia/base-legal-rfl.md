...
**Status:** fontes verificadas em texto oficial (planalto.gov.br); PDFs compilados oficiais arquivados em `bibliografia/normas/`; ainda não incorporado ao corpo da dissertação — só entra quando o módulo Python for de fato escrito.
...
**Confirmado diretamente no Anexo do PDF oficial** (`bibliografia/normas/decreto-6306-2007-iof-compilado.pdf`, última página): os 30 valores acima batem exatamente com a tabela "Nº de dias / % LIMITE DO RENDIMENTO" do Anexo do decreto. Ressalva anterior (não conferido caractere a caractere) resolvida.

## 2. IR regressivo

**Base legal:** Lei nº 11.033/2004, art. 1º. Confirmado com o texto legal completo em `bibliografia/normas/lei-11033-2004-ir-compilado.pdf`, sem ressalva. O próprio texto compilado já traz a anotação "(Vide Medida Provisória nº 1.303, de 2025)" com "Vigência encerrada" riscado sobre o caput do art. 1º -- confirmação direta, na fonte primária, de que a tentativa de alteração relatada no item 3 abaixo não vingou.
...
## 4. Fontes oficiais (versões compiladas, já incorporam alterações posteriores)

- Decreto nº 6.306/2007: https://www.planalto.gov.br/ccivil_03/_ato2007-2010/2007/decreto/d6306compilado.htm -- PDF arquivado em `bibliografia/normas/decreto-6306-2007-iof-compilado.pdf`
- Lei nº 11.033/2004: https://www.planalto.gov.br/ccivil_03/_ato2004-2006/2004/lei/l11033compilado.htm -- PDF arquivado em `bibliografia/normas/lei-11033-2004-ir-compilado.pdf`
